...
namespace Shipping.CPost.Controllers
{
    ...
    public class CPostShippingSettingsController : BaseShippingController
    {
        private readonly IWarehouseService _warehouseService;
        private readonly IShippingMethodService _shippingMethodService;
        private readonly IStoreService _storeService;
        private readonly ICountryService _countryService;
        private readonly CPostShippingSettings _shippingCPostSettings;
        private readonly ICPostShippingService _shippingCPostService;
        ...
        public CPostShippingSettingsController(
            IWarehouseService warehouseService,
            IShippingMethodService shippingMethodService,
            IStoreService storeService,
            ICountryService countryService,
            CPostShippingSettings shippingCPostSettings,
            ICPostShippingService shippingCPostService,
            ...
            MeasureSettings measureSettings)
        {
            ...
            _shippingCPostSettings = shippingCPostSettings;
            _shippingCPostService = shippingCPostService;
        ...
        {
            var model = new CPostShippingListModel();

            model.LimitMethodsToCreated = _shippingCPostSettings.LimitMethodsToCreated;
            model.DisplayOrder = _shippingCPostSettings.DisplayOrder;
        ...
        public async Task<IActionResult> SaveGeneralSettings(CPostShippingListModel model)
        {
            //save settings
            _shippingCPostSettings.LimitMethodsToCreated = model.LimitMethodsToCreated;
            _shippingCPostSettings.DisplayOrder = model.DisplayOrder;

            await _settingService.SaveSetting(_shippingCPostSettings);
        ...
        //{
        //    var records = await _shippingCPostService.GetAll(command.Page - 1, command.PageSize);

        //    var sbwModel = new List<CPostShippingModel>();
        //    foreach (var x in records)
        //    {

        //        var m = new CPostShippingModel
        //        {
        //            Id = x.Id,
        //            StoreId = x.StoreId,
        ...
        //        htmlSb.AppendFormat("{0}: {1}", _translationService.GetResource("Plugins.Shipping.CPost.Fields.From"), m.From);
        //        htmlSb.Append("<br />");
        //        htmlSb.AppendFormat("{0}: {1}", _translationService.GetResource("Plugins.Shipping.CPost.Fields.To"), m.To);
        //        htmlSb.Append("<br />");
        //        htmlSb.AppendFormat("{0}: {1}", _translationService.GetResource("Plugins.Shipping.CPost.Fields.AdditionalFixedCost"), m.AdditionalFixedCost);
        //        htmlSb.Append("<br />");
        //        htmlSb.AppendFormat("{0}: {1}", _translationService.GetResource("Plugins.Shipping.CPost.Fields.RatePerWeightUnit"), m.RatePerWeightUnit);
        //        htmlSb.Append("<br />");
        //        htmlSb.AppendFormat("{0}: {1}", _translationService.GetResource("Plugins.Shipping.CPost.Fields.LowerWeightLimit"), m.LowerWeightLimit);
        //        htmlSb.Append("<br />");
        //        htmlSb.AppendFormat("{0}: {1}", _translationService.GetResource("Plugins.Shipping.CPost.Fields.PercentageRateOfSubtotal"), m.PercentageRateOfSubtotal);
        ...
        //{
        //    var sbw = await _shippingCPostService.GetById(id);
        //    if (sbw != null)
        //        await _shippingCPostService.DeleteCPostShippingRecord(sbw);
        ...
        //{
        //    var model = new CPostShippingModel();
        ...
        //[HttpPost]
        //[AutoValidateAntiforgeryToken]
        //public async Task<IActionResult> AddPopup(CPostShippingModel model)
        //{
        //    var sbw = new CPostShippingRecord
        //    {
        ...
        //    };
        //    await _shippingCPostService.InsertCPostShippingRecord(sbw);
        ...
        //[HttpPost]
        //[AutoValidateAntiforgeryToken]
        //public async Task<IActionResult> EditPopup(CPostShippingModel model)
        //{
        //    var sbw = await _shippingCPostService.GetById(model.Id);
        //    if (sbw == null)
        //        //No record found with the specified id
        //        return RedirectToAction("Configure");
        ...
        //    await _shippingCPostService.UpdateCPostShippingRecord(sbw);
